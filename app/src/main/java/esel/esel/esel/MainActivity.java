            ...
            public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
                if (key.equals("use_patched_es")){
                    if (SP.getBoolean("use_patched_es", false)){
                        ...
                        EselLog.LogV(TAG, "START patches_es keepAlive recievers");
                        Esel.getsInstance().startReadReceiver();
                        EselLog.LogV(TAG, "START patches_es Read recievers");
                    } else {
                        Esel.getsInstance().stopReadReceiver();
                        EselLog.LogV(TAG, "STOP patches_es Read recievers");
                        Esel.getsInstance().stopKeepAliveService();
                        EselLog.LogV(TAG, "STOP patches_es keepAlive recievers");
                    }
                }
            }
        };
